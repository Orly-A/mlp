...
def hyperparam_search(grid_params, groups, X, y, weights):
    ...
    clf = MLPClassifier(sample_weight=weights)
...
if __name__ == "__main__":
    ##########################
    #This doesnt work, not sure where to pass the sample_weight parameter
    ##########################
    ...
    best_params = hyperparam_search(grid_params, groups, X, y, weights)
